        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Dormitory</li>
                </ol>
            </nav>
        </div>
            <a class="btn btn-primary float-right btn-icon btn-sm" type="button" href="{{ route('dormitories.create') }}" >
            <i class="icon ion-ios-create mr-2"></i>Add New Dormitory
            </a> 
    </div>
    ...
    <div data-label="owners" class="df-example demo-table">
            <table id="owners" class="table">
                ...
                <tr> 
                    ...
                    <th class="wd-20p"> Dorm Master</th>
                ...
                $(function () {
                    ...
                    $('#owners').DataTable({
                        ...
                        columns: [
                            ...
                            /*  
                            `name`, `dormmaster`, `year`, `nofstudents`,*/
                            {data: 'name', name: 'name'},
                            {data: 'dormmaster', name: 'dormmaster'},
