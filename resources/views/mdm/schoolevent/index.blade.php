        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">School Events</li>
                </ol>
            </nav>
        </div>
            <a class="btn btn-primary float-right btn-icon btn-sm" type="button" href="{{ route('streams.create') }}" >
            <i class="icon ion-ios-create mr-2"></i>Add New Event
            </a> 
    </div>
