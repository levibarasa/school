...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
            ...
            <i class="icon ion-ios-create mr-2"></i> Add New Class
            </a> 
    </div>
    ...
    <div data-label="owners" class="df-example demo-table">
            <table id="owners" class="table">
                ...
                <tr> 
                    ...
                    <th class="wd-15p">Number of Students</th> 
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content tx-14">
                    <div class="modal-header">
                        <h6 class="modal-title" id="exampleModalLabel">New Class</h6>
                    ...
                    <div class="modal-body">
                        ...
                        <form data-parsley-validate="" novalidate="" method="POST" action="{{ route('grades.store') }}">
                            @csrf
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" id="nofstudents" name="nofstudents" placeholder="Capacity" required>
                            </div> 
                ...
                $(function () {
                    ...
                    $('#owners').DataTable({
                        ...
                        columns: [
                            ...
                            {data: 'name', name: 'name'},
                            {data: 'nofstudents', name: 'nofstudents'},  
