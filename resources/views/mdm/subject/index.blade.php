...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        <div>
            ...
            <a class="btn btn-primary float-right btn-icon btn-sm" type="button" href="{{ route('subjects.create') }}" >
            <i class="icon ion-ios-create mr-2"></i>Add New Subject
            </a> 
    </div>
    ...
    <div data-label="owners" class="df-example demo-table">
            <table id="owners" class="table">
                ...
                <tr> 
                    ...
                    <th class="wd-15p">Cluster Group</th> 
                ...
                $(function () {
                    ...
                    $('#owners').DataTable({
                        ...
                        columns: [
                            ...
                            */
                            {data: 'name', name: 'name'},
                            {data: 'clustergroup', name: 'clustergroup'},  
